...
const FileIcon = ({
  color: _color = 'whitesmoke',
  extension,
  fold: _fold = true,
  foldColor,
  glyphColor,
  gradientColor: _gradientColor = 'white',
  gradientOpacity: _gradientOpacity = 0.25,
  labelColor,
  labelTextColor: _labelTextColor = 'white',
  labelUppercase: _labelUppercase = false,
  radius: _radius = 4,
  svgProps: _svgProps = null,
  type
}) => {
  ...
  return /*#__PURE__*/React.createElement("svg", _extends({
  ...
  }, _svgProps), /*#__PURE__*/React.createElement("defs", null, /*#__PURE__*/React.createElement("clipPath", {
    ...
    stopColor: _gradientColor,
    stopOpacity: _gradientOpacity,
    offset: "0%"
  }), /*#__PURE__*/React.createElement("stop", {
    stopColor: _gradientColor,
    stopOpacity: "0",
  ...
  }, _fold ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
    ...
    height: ICON.HEIGHT,
    fill: `url(#pageGradient${UNIQUE_ID})`
  }))), _fold && /*#__PURE__*/React.createElement("g", {
    transform: `translate(28 ${FOLD.HEIGHT}) rotate(-90)`
  }, /*#__PURE__*/React.createElement("rect", {
    width: ICON.WIDTH,
    height: ICON.HEIGHT,
    fill: foldColor || colord(_color).darken(0.1).toHex(),
    rx: _radius,
    ry: _radius,
    ...
    fill: labelColor || colord(_color).darken(0.3).toHex(),
    x: ICON.X_OFFSET,
    ...
    fontSize: "9",
    fill: _labelTextColor,
    textAnchor: "middle",
    style: {
      fontWeight: 'bold',
      textAlign: 'center',
      pointerEvents: 'none',
      textTransform: _labelUppercase ? 'uppercase' : 'none',
      userSelect: 'none'
    }
  }, extension))), type && /*#__PURE__*/React.createElement("g", {
    transform: `translate(-4 ${!extension ? 6 : 0})`,
    fill: glyphColor || colord(_color).darken(0.15).toHex()
  }, glyphs[type]));
};
